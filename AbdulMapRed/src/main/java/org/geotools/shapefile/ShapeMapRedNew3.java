...
public class ShapeMapRedNew3 {
    ...
    public static class ShapeFileMapper extends Mapper<Text, BytesWritable, Text, Text> {
        ...
        public void map(Text filepath, BytesWritable filecontent, Context context) throws IOException, InterruptedException {
            ...
            try {
                ...
                count = countFeaturesNew_old(filecontent.getBytes());
                if (count == "-1") {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length < 2) {
            ...
            System.err.println("Usage: ShapeMapRedNew3 <in> <out>");
            System.exit(2);
        }
        Job job = new Job(conf, "ShapeMapRedNew3");
        Date dat1 = new Date();
        System.out.println("Started at time: "+ dat1.getTime()  + "(ms)...");
        job.setJobName(ShapeMapRedNew3.class.getSimpleName());
        job.setJarByClass(ShapeMapRedNew3.class);
        ...
        System.out.println("Completed at time: "+ dat2.getTime()  + "(ms)...");
