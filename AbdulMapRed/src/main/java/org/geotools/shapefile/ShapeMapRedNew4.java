...
public class ShapeMapRedNew4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length < 2) {
            ...
            System.err.println("Usage: ShapeMapRedNew4 <in> <out>");
            System.exit(2);
        }
        Job job = new Job(conf, "ShapeMapRedNew4");
        Date dat1 = new Date();
        System.out.println("Started ShapeMapRedNew4 at time: "+ dat1.getTime()  + "(ms)...");
        job.setJobName(ShapeMapRedNew4.class.getSimpleName());
        job.setJarByClass(ShapeMapRedNew4.class);
        ...
        System.out.println("Completed ShapeMapRedNew4 at time: "+ dat2.getTime()  + "(ms)...");
